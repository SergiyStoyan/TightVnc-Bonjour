...
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("CisteraVNC Server");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\CisteraVNC\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\CisteraVNC\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\CisteraVNC\\Control\\DispatcherConnectionHistory");
...
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("CisteraVNC Server");
...
const TCHAR DefaultNames::DEFAULT_COMPUTER_NAME[] = _T("CisteraVNC Server");


const char HttpStrings::HTTP_INDEX_PAGE_FORMAT[] =
"<HTML>\n"
"  <HEAD><TITLE>CisteraVNC desktop [%.256s]</TITLE></HEAD>\n"
"  <BODY>\n"
...
"%.1024s"
"    </APPLET><BR>\n"
"    <A HREF=\"http://www.cistera.com/\">www.CisteraVNC.com</A>\n"
"  </BODY>\n"
"</HTML>\n";

const char HttpStrings::HTTP_MSG_BADPARAMS[] =
"<HTML>\n"
"  <HEAD><TITLE>CisteraVNC desktop</TITLE></HEAD>\n"
"  <BODY>\n"
