  ...
  m_log(log)
{
  ...
  registrator->addSrvToClCap(FTMessage::COMPRESSION_SUPPORT_REPLY, VendorDefs::CISTERAVNC, FTMessage::COMPRESSION_SUPPORT_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::FILE_LIST_REPLY, VendorDefs::CISTERAVNC, FTMessage::FILE_LIST_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::MD5_REPLY, VendorDefs::CISTERAVNC, FTMessage::MD5_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::UPLOAD_START_REPLY, VendorDefs::CISTERAVNC, FTMessage::UPLOAD_START_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::UPLOAD_DATA_REPLY, VendorDefs::CISTERAVNC, FTMessage::UPLOAD_DATA_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::UPLOAD_END_REPLY, VendorDefs::CISTERAVNC, FTMessage::UPLOAD_END_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DOWNLOAD_START_REPLY, VendorDefs::CISTERAVNC, FTMessage::DOWNLOAD_START_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DOWNLOAD_DATA_REPLY, VendorDefs::CISTERAVNC, FTMessage::DOWNLOAD_DATA_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DOWNLOAD_END_REPLY, VendorDefs::CISTERAVNC, FTMessage::DOWNLOAD_END_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::MKDIR_REPLY, VendorDefs::CISTERAVNC, FTMessage::MKDIR_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::REMOVE_REPLY, VendorDefs::CISTERAVNC, FTMessage::REMOVE_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::RENAME_REPLY, VendorDefs::CISTERAVNC, FTMessage::RENAME_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::DIRSIZE_REPLY, VendorDefs::CISTERAVNC, FTMessage::DIRSIZE_REPLY_SIG);
  registrator->addSrvToClCap(FTMessage::LAST_REQUEST_FAILED_REPLY, VendorDefs::CISTERAVNC, FTMessage::LAST_REQUEST_FAILED_REPLY_SIG);

  registrator->addClToSrvCap(FTMessage::COMPRESSION_SUPPORT_REQUEST, VendorDefs::CISTERAVNC, FTMessage::COMPRESSION_SUPPORT_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::FILE_LIST_REQUEST, VendorDefs::CISTERAVNC, FTMessage::FILE_LIST_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::MD5_REQUEST, VendorDefs::CISTERAVNC, FTMessage::MD5_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::UPLOAD_START_REQUEST, VendorDefs::CISTERAVNC, FTMessage::UPLOAD_START_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::UPLOAD_DATA_REQUEST, VendorDefs::CISTERAVNC, FTMessage::UPLOAD_DATA_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::UPLOAD_END_REQUEST, VendorDefs::CISTERAVNC, FTMessage::UPLOAD_END_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::DOWNLOAD_START_REQUEST, VendorDefs::CISTERAVNC, FTMessage::DOWNLOAD_START_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::DOWNLOAD_DATA_REQUEST, VendorDefs::CISTERAVNC, FTMessage::DOWNLOAD_DATA_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::MKDIR_REQUEST, VendorDefs::CISTERAVNC, FTMessage::MKDIR_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::REMOVE_REQUEST, VendorDefs::CISTERAVNC, FTMessage::REMOVE_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::RENAME_REQUEST, VendorDefs::CISTERAVNC, FTMessage::RENAME_REQUEST_SIG);
  registrator->addClToSrvCap(FTMessage::DIRSIZE_REQUEST, VendorDefs::CISTERAVNC, FTMessage::DIRSIZE_REQUEST_SIG);
